...
import '../assets/styles/Cipersonal.css'; // Assuming you have a specific CSS file for this component
...
const Cipersonal: React.FC = () => {
	...
	return (
		<>
			<Helmet>
				<title>Capital Intelectual Personal</title>
			</Helmet>
			<div className="ci-container">
				<h1>Capital Intelectual Personal</h1>
				<p>Leunel Aquino Dávila</p>
				...
				<section className="ci-section">
					...
					<div className="ci-indicator">
						<h3>📘 Conocimiento</h3>
						<p>% de dominio teórico en áreas clave.</p>
						<p>
							<strong>Fórmula:</strong>{' '}
							<InlineMath math="(\frac{\text{Cursos aprobados}}{5} \times 100 + \text{Autoevaluación} \times 10) / 2" />
						</p>
						<div className="ci-input-group">
							<label>Cursos técnicos aprobados (de 0 a 5):</label>
							<input
								type="number"
								min="0"
								max="5"
					...
					<div className="ci-indicator">
						<h3>🛠️ Habilidades</h3>
						<p>Dominio técnico aplicable a herramientas o metodologías.</p>
						<p>
							<strong>Fórmula:</strong>{' '}
							<InlineMath math="(\frac{\text{Proyectos técnicos}}{5} \times 100 + \frac{\text{Años experiencia}}{5} \times 100 + \text{Evaluación técnica} \times 10) / 3" />
						</p>
						<div className="ci-input-group">
							<label>Proyectos técnicos realizados:</label>
							<input
								type="number"
								min="0"
								max="20"
						...
						<div className="ci-input-group">
							<label>Años de experiencia técnica:</label>
							<input
								type="number"
								min="0"
								max="10"
					...
					<div className="ci-indicator">
						<h3>🔧 Destrezas</h3>
						<p>Aplicación práctica con precisión y rapidez.</p>
						<p>
							<strong>Fórmula:</strong>{' '}
							<InlineMath math="((100 - \text{Tiempo} \times 2) + \text{Calidad} \times 10 + \text{Feedback} \times 10) / 3" />
						</p>
						<div className="ci-input-group">
							<label>Tiempo promedio de resolución (minutos):</label>
							<input
								type="number"
								min="1"
								max="120"
				...
				<section className="ci-section">
					...
					<div className="ci-indicator">
						...
						<p>
							<strong>Fórmula:</strong>{' '}
							<InlineMath math="(\frac{\text{Recomendaciones escritas}}{5} \times 100 + \frac{\text{Testimonios}}{5} \times 100 + \frac{\text{Reconocimientos públicos}}{5} \times 100) / 3" />
						</p>
						<div className="ci-input-group">
				...
				<section className="ci-section">
					...
					<p>
						<strong>Fórmula:</strong>{' '}
						<InlineMath math="(\text{Adaptabilidad} + \text{Organización} + \text{Resolución}) / 3" />
					</p>
					...
					<div className="ci-indicator">
						...
						<p>Métodos internos para gestionar recursos y tareas.</p>
						<p>
							<strong>Fórmula:</strong>{' '}
							<InlineMath math="(\frac{\text{Uso de metodologías}}{3} \times 100 + \text{Productividad diaria} \times 10 + \text{Metas alcanzadas}) / 3" />
						</p>
						<div className="ci-input-group">
							<label>Uso de metodologías (1-3):</label>
							<input
								type="number"
								min="1"
								max="3"
						...
						<div className="ci-result">
							Organización: {organizacion.toFixed(2)}%
						</div>
					</div>

					<div className="ci-indicator">
						<h3>🔍 Resolución</h3>
						<p>Capacidad analítica y creativa para resolver problemas.</p>
						<p>
							<strong>Fórmula:</strong>{' '}
							<InlineMath math="(\frac{\text{Análisis previo}}{5} \times 100 + \frac{\text{Creatividad solución}}{5} \times 100 + \frac{\text{Eficacia solución}}{5} \times 100) / 3" />
						</p>
						<div className="ci-input-group">
						...
						<div className="ci-result">
							Resolución: {resolucion.toFixed(2)}%
						</div>
					</div>
				...
				<section className="ci-result">
					...
					<p>Escala: 0% (mínimo) - 100% (máximo)</p>
				</section>
			</div>
		</>
	);
